...
@JsonComponent
public class PairOfCardSuitCardValueSerializer
    extends JsonSerializer<Pair<CardSuit, CardFaceValue>> {
  @Override
  public void serialize(Pair<CardSuit, CardFaceValue> objects,
                        JsonGenerator jsonGenerator,
                        SerializerProvider serializerProvider) throws IOException {
    jsonGenerator
        .writeString(objects.getValue0().toString() + ":" + objects.getValue1().toString());
  }
}
