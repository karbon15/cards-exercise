...
public class GameDeckServiceImplTests {
  ...
  void dealingZeroCards() {
    ...
    Assertions.assertThrows(InvalidDealCountException.class,
        () -> deckService.dealCards(gameId, howMany));
  }
  ...
  public void gettingUndealtCardsBySuitAndValue() {
    ...
    Map<Pair<CardSuit, CardFaceValue>, Integer> counts =
        deckService.getUndealtCardCountBySuitAndValue(gameId);
